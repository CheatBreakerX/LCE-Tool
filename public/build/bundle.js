...
var app = (function () {
    ...
    */
    ...
    function create_fragment(ctx) {
    	...
    	let br;
    	let t6;
    	let t7_value = (/*listSel*/ ctx[1] ? "checked" : "unchecked") + "";
    	let t7;
    	let t8;
    	let p1;
    	let t9;
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			append_dev(div, t10);
    			mount_component(fluent_contentdialog, div, null);
    			current = true;
    		},
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*value*/ 4) set_data_dev(t4, /*value*/ ctx[2]);
    			if ((!current || dirty & /*listSel*/ 2) && t7_value !== (t7_value = (/*listSel*/ ctx[1] ? "checked" : "unchecked") + "")) set_data_dev(t7, t7_value);
